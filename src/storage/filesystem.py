"""File system operations for scrapers."""
...
class FileSystem:
    """Manages all file operations for scrapers."""
    ...
    def __init__(self, data_dir: str = "Data", custom_date: Optional[str] = None):
        ...
        Args:
            ...
            custom_date: Optional custom date string (YYYY-MM-DD) for testing.
                        If None, uses today's date.
        """
        self.data_dir = data_dir
        if custom_date:
            self.today = custom_date
        else:
